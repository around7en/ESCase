...
######################################################################
if {! $IS_CHIP} {
    create_clock -name ${RTC_SYS_NAME}_rtc32k_clk           -period $CYCLE_1M      -add [get_ports rtc32k_clk]
    create_clock -name ${RTC_SYS_NAME}_V_CLK_1M92           -period $CYCLE_1M92

    lappend CLOCK_GROUP(clk_rtc32k_anlg)                    [list ${RTC_SYS_NAME}_rtc32k_clk]
    set CLOCK_GROUP(${RTC_SYS_NAME}_V_CLK_1M92)             [list ${RTC_SYS_NAME}_V_CLK_1M92]
