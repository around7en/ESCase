...
#
#####################################################
set CLK1_ONETHIRD     [expr 0.30 * $CLK1_PERIOD]
...
### Group all inputs ###
if {! $IS_CHIP} {
    set clk1_input " ${IP_NAME}_rxd "
    set clk1_output " ${IP_NAME}_txd "
} else {
    set clk1_input " $func_pad_names(can_rxd${PAD_INDEX}) "
    set clk1_output " $func_pad_names(can_txd${PAD_INDEX}) "
}
### Group all outputs ###
